...
ASM_INLINE("_8B9FC:");
	...
	ASM_INLINE("PUSH	BX");
	ASM_INLINE("MOV	CX,SEG chara_name_");
...
ASM_INLINE("_8C213:");
	...
	ASM_INLINE("MOV	BX,SEG type_name_");
	ASM_INLINE("MOV	ES,BX");
...
ASM_INLINE("_8C280:");
	...
	ASM_INLINE("ADD	SP,0x0002");
	ASM_INLINE("LEA	SI,[BP-0x33].B");
	ASM_INLINE("MOV	BX,SEG chara_name_");
	ASM_INLINE("MOV	ES,BX");
...
ASM_INLINE("_8C4FD:");
	...
	ASM_INLINE("CBW");
	ASM_INLINE("MOV	DI,AX");
	ASM_INLINE("MOV	BX,G_FUNC_char_adr_");
	ASM_INLINE("MOV	AX,SEG G_FUNC_char_adr_");
	ASM_INLINE("PUSH	AX");
	ASM_INLINE("PUSH	BX");
...
ASM_INLINE("_8C57E:");
	ASM_INLINE("MOV	BX,G_UNISE2_char_adr_");
	ASM_INLINE("MOV	AX,SEG G_UNISE2_char_adr_");
	ASM_INLINE("PUSH	AX");
	ASM_INLINE("PUSH	BX");
	ASM_INLINE("MOV	AX,0x0001");
	ASM_INLINE("PUSH	AX");
