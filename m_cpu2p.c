...
ASM_INLINE("_89169:");
	...
	ASM_INLINE("CALLF	0x02C5, 0x8684");
ASM_INLINE("_89176:");
	ASM_INLINE("PUSH	SI");
	ASM_INLINE("LEA	DI,[BP-0x58].B");
	ASM_INLINE("MOV	SI,0x05A8");
	ASM_INLINE("MOV	CX,0x0016");
	ASM_INLINE("PUSH	DS");
	ASM_INLINE("POP	ES");
	ASM_INLINE("CLD");
	...
	ASM_INLINE("CALLF	0x1505, 0x8684");
	ASM_INLINE("ADD	SP,0x0002");
ASM_INLINE("_891BF:");
	ASM_INLINE("PUSH	SI");
	ASM_INLINE("LEA	DI,[BP-0x6E].B");
	ASM_INLINE("MOV	SI,0x05BE");
	ASM_INLINE("MOV	CX,0x0016");
	ASM_INLINE("PUSH	DS");
	ASM_INLINE("POP	ES");
	ASM_INLINE("CLD");
	...
	ASM_INLINE("XOR	BH,BH");
	ASM_INLINE("CALLF	0x0001, 0x9042");
...
ASM_INLINE("_892B5:");
	...
	ASM_INLINE("CALLF	0x0E67, 0x8684");
	ASM_INLINE("ADD	SP,0x0002");
	ASM_INLINE("INC	DI");
ASM_INLINE("_892C8:");
...
ASM_INLINE("_89857:");
	...
	ASM_INLINE("XOR	DH,DH");
	ASM_INLINE("CALLF	0x11CF, 0x8684");
	ASM_INLINE("ADD	SP,0x0002");
	ASM_INLINE("TEST	AX,AX");
...
ASM_INLINE("_898AA:");
	...
	ASM_INLINE("CALLF	0x1396, 0x8684");
...
ASM_INLINE("_89991:");
	...
	ASM_INLINE("MOV	DX,[BP-0x0C].W");
	ASM_INLINE("CALLF	0x1227, 0x8684");
	ASM_INLINE("ADD	SP,0x0004");
	ASM_INLINE("MOV	[BP-0x0A].W,AX");
	ASM_INLINE("MOV	BX,[BP-0x08].W");
	ASM_INLINE("MOV	[BX+0x04].W,0x0000");
