...
ASM_INLINE("_8DA86:");
	...
	ASM_INLINE("MOV	SI,location_table_");
	ASM_INLINE("MOV	BX,SEG location_table_");
	ASM_INLINE("SHL	AX,1");
	ASM_INLINE("SHL	AX,1");
	ASM_INLINE("SHL	AX,1");
	...
	ASM_INLINE("MOV	SI,position_table_");
	ASM_INLINE("MOV	AX,SEG position_table_");
	ASM_INLINE("POP	BX");
	ASM_INLINE("SHL	BX,1");
	ASM_INLINE("SHL	BX,1");
...
ASM_INLINE("_8DAC2:");
	ASM_INLINE("PUSH	DX");
	ASM_INLINE("PUSH	CX");
	ASM_INLINE("MOV	BX,G_TUNEUP_char_adr_");
	ASM_INLINE("MOV	AX,SEG G_TUNEUP_char_adr_");
	ASM_INLINE("PUSH	AX");
	ASM_INLINE("PUSH	BX");
...
static void near unk_8DC88(u16 a, u16 b, u16 c, u16 d, u16 e, u16 f)
{
	...
	ASM_INLINE("MOV	DX,location_table_");
	ASM_INLINE("MOV	CX,SEG location_table_");
	ASM_INLINE("SHL	AX,1");
	ASM_INLINE("SHL	AX,1");
	ASM_INLINE("SHL	AX,1");
	...
	ASM_INLINE("MOV	CX,position_table_");
	ASM_INLINE("MOV	AX,SEG position_table_");
	ASM_INLINE("SHL	BX,1");
	ASM_INLINE("SHL	BX,1");
...
static void near unk_8DE28(u16 a, u16 b, u16 c, u16 d, u16 e, u16 f)
{
	...
	ASM_INLINE("PUSH	DI");
	ASM_INLINE("PUSH	SI");
	ASM_INLINE("MOV	DI,location_table_");
	ASM_INLINE("MOV	SI,SEG location_table_");
	ASM_INLINE("SHL	AX,1");
	ASM_INLINE("SHL	AX,1");
	ASM_INLINE("SHL	AX,1");
	...
	ASM_INLINE("MOV	DI,position_table_");
	ASM_INLINE("MOV	AX,SEG position_table_");
	ASM_INLINE("SHL	BX,1");
	ASM_INLINE("SHL	BX,1");
...
ASM_INLINE("_8F7FF:");
	...
	ASM_INLINE("MOV	AX,DI");
	ASM_INLINE("MOV	BX,0x0005");
	ASM_INLINE("MOV	CX,SEG tune_func_");
