...
void serial_receive()
{
	...
	ASM_INLINE("CMP	[com_user_].B,0x01");
...
ASM_INLINE("_82D49:");
	ASM_INLINE("CMP	[com_user_].B,0x00");
...
static void near unk_82FD3()
{
	...
	ASM_INLINE("MOV	[com_user_].B,0x01");
...
ASM_INLINE("_82FEE:");
	...
	ASM_INLINE("RET");
ASM_INLINE("_82FF2:");
	ASM_INLINE("MOV	[com_user_].B,0x00");
	ASM_INLINE("MOV	AX,0x0001");
	ASM_INLINE("RET");
ASM_INLINE("_82FFB:");
...
ASM_INLINE("_83064:");
	...
	ASM_INLINE("MOV	[com_user_].B,0x02");
	ASM_INLINE("JMP	_83094");
ASM_INLINE("_8306F:");
	ASM_INLINE("MOV	[com_user_].B,0x01");
	ASM_INLINE("JMP	_83094");
